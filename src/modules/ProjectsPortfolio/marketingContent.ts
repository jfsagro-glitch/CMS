...
export const HERO = {
  title: 'Digital agency for business process automation & RPA',
  subtitle:
...
export const BRAND = {
  shortKicker: 'ОБНОВЛЁННАЯ ЛЕГЕНДА БРЕНДА CMS',
  shortTitle: 'CMS — Corporate Management Systems',
  shortText:
    'Системный анализ бизнес‑процессов и архитектура автоматизации. Основано на 20+ годах практики оценки, анализа и сопровождения бизнесов в финансовой и корпоративной среде.',
  storyIntro:
  ...
  principlesTitle: 'CMS работает с бизнесом как с системой, где',
  principles: [
