...
const realEstateCommonAttributes: CollateralAttribute[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'Земли особоохраняемых территорий и',
      'Земли промышленности, энергетики, тр',
      'Земли сельскохозяйственного назначен',
...
const commercialRealEstateAttributes: CollateralAttribute[] = [
  ...
  },
  {
    ...
    options: [
      'Деревянные',
      'Кирпич',
      'Кирпичный/Сталинский',
      'Металлические без утепления',
      'Монолит/Монолит-кирпич',
      'Панельный/блочный',
      'Пенобетонные/Газобетонное блоки',
      'Сэндвич панели',
      '-',
    ],
    group: 'Параметры объекта',
  ...
  },
  {
    ...
    options: [
      ...
      'Простая',
      'Среднее',
      'Требуется кап. ремонт/Без отделки',
      'Улучшенная',
      '-',
    ],
    group: 'Состояние',
